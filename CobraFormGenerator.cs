...
namespace DigiDocWebApp.Utils
{
    public static class CobraFormGenerator
    {
        public static FormTemplate CreateCobraAdministrationForm()
        {
